...
if(isset($_POST["u"])){
	...
	// END FORM DATA ERROR HANDLING
		...
		$cryptpass = crypt($p);
		include_once ("js/php_includes/randStrGen.php");
...
<body>
<?php include_once("js/template_pageTop.php"); ?>
<div id="pageMiddle">
  <h3>Sign Up Here</h3>
  <form name="signupform" id="signupform" onsubmit="return false;">
    ...
    <select id="country" onfocus="emptyElement('status')">
      <?php include_once("js/template_country_list.php"); ?>
    </select>
    <div>
...
<?php include_once("js/template_pageBottom.php"); ?>
</body>
</html>
